...
class SalesforceConnection(object):
    ...
    def report(self):
        ...
        path = '/services/data/v35.0/analytics/reports/00O16000007YmrWEAS'
#        path = '/services/data/v35.0/analytics/reports/00O16000007YmrWEAS/instances'
#        path = '/services/data/v35.0/analytics/reports/00O16000007YmrWEAS/instances/0LGq00000002TzRGAU'
        url = '{}{}'.format(self.instance_url, path)
